    ...
    const submitTreasureGuess = () => {
      ...
      if (opponent === "friend") {
        ...
        Promise.all(selectedFriends.map((friend) => sendFriendInviteEmail({
          ...
          .catch(() => setFriendInviteStatus("Your tiles were saved here, but the email invite could not be sent yet. Check Resend and Vercel settings."));
        return;
      }
    ...
    const renderTreasurePlacementControls = () => {
      if (typeof (globalThis as any).document !== "undefined") {
        ...
        return React.createElement(
          ...
          React.createElement("div", { style: { color: "#8A6B20", fontSize: 12, fontWeight: 900, lineHeight: "17px", marginBottom: 12, textAlign: "center" } }, opponent === "friend" ? "Arrange your five treasure tiles, then submit them for your friend to answer." : "Drag treasures into the boxes below, or tap a treasure to place it in the next open box."),
          ...
          React.createElement(
            ...
            opponent === "friend" ? "Submit my tiles" : "Try unlocking"
          )
        );
      }
      return (
        <View>
          ...
          <Text style={styles.treasurePlacementHint}>
            {opponent === "friend"
              ? "Arrange your five treasure tiles, then submit them for your friend to answer."
          ...
          >
            ...
            <Text style={styles.primaryButtonText}>{opponent === "friend" ? "Submit my tiles" : "Try unlocking"}</Text>
          </Pressable>
        </View>
      );
    };
          ...
          <View>
            ...
            <View style={styles.friendPhoneRow}>
              ...
              <Pressable
                ...
                onPress={addTreasureFriend}
                style={[styles.addFriendButton, (!friendName.trim() || !friendEmail.trim()) && styles.disabledButton]}
              >
        ...
        {treasureFlowStep === "choose" ? null : !treasureStarted || treasureWinText ? (
          ...
          >
            ...
            <Text style={styles.primaryButtonText}>
              {treasureWinText ? "Play again" : opponent === "friend" ? "Continue to my tiles" : "Start computer game"}
            </Text>
          </Pressable>
        ) : (
